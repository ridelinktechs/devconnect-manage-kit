...
/// as bordered cards with a count badge and a list of [HeaderRowCopy]
/// rows underneath each.
///
/// Local copy of `HeadersView` in `all_events/presentation/network/`. Kept
/// separate per the "no cross-feature imports" refactor convention so this
/// feature can evolve its headers chrome independently.
class HeadersTab extends StatefulWidget {
  final NetworkEntry entry;

  const HeadersTab({super.key, required this.entry});
